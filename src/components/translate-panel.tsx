...
export function TranslatePanel({
  ...
  async function onTranslate() {
    ...
    if (!result.ok) {
      setError(result.error === "config" ? copy.translationUnavailable : copy.authError);
      return;
    }
  ...
  const helpNeeded = showTranslation && translated ? translated.helpNeeded : originalHelpNeeded;
